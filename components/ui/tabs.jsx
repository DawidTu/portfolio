...
const TabsList = React.forwardRef(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex items-center justify-center xl:bg-white p-1 text-mounted-foreground rounded-[5px] dark:md:bg-secondary",
      className
    )}
    {...props} />
))
