                        ...
                        <div className="text-lg mt-12 xl:mt-8">
                            <TabsContent value='personal'>
                                <div className="text-center xl:text-left">
                                    <h3 className="h3 mb-4">„Od nováčika k poznaniu: Môj príbeh kódovania“</h3>
                                    <p className="subtitle max-w-xl mx-auto xl:mx-0">
                                        Preskúmajte moje portfólio, 
                                        aby ste boli svedkami prvých kapitol môjho príbehu o kódovaní.
                                    </p>
                            ...
                            <TabsContent value='qualification'>
                                <div>
                                    <h3 className="h3 mb-8 text-center xl:text-left">Moja začínajúca cesta</h3>
                                    <div className="grid md:grid-cols-2 gap-8">
                                        <div className="flex flex-col gap-y-6">
                                            ...
                                            <div className="flex flex-col gap-y-8">
                                                {getData(qualificationData, 'skúsenosti').data.map((item, index) => {
                                                    const {projects, qualification, start } = item;
                                                    return(
                                                        
                                                        <div className="flex gap-x-8 group mt-2" key={index}>
                                                            <div className="h-[84px] w-[1px] bg-border relative ml-2">
                                                                <div className="w-[11px] h-[11px] rounded-full bg-primary absolute -left-[5px] group-hover:translate-y-[84px] transition-all duration-500"></div>
                                                            </div>
                                                            <div>
                                                                <div className="font-semibolf text-xl leading-none mb-2">{projects}</div>
                                        ...
                                        <div className="flex flex-col gap-y-6">
                                            <div className="flex gap-x-4 items-center text-[22px] text-primary">
                                                ...
                                                <h4 className="capitalize font-medium">
                                                    {getData(qualificationData, 'absolvované kurzy').title}
                                                </h4>
                                            </div>
                                            <div className="flex flex-col gap-y-8">
                                                {getData(qualificationData, 'absolvované kurzy').data.map((item, index) => {
                                                    ...
                                                    return(
                                                        ...
                                                        <div className="flex gap-x-8 group mt-2" key={index}>
                                                            ...
                                                            <div>
                                                                ...
                                                                <div className="text-lg leading-none text-muted-foreground mb-3">{finish}</div>
                                                                <div>{education}</div>
                                                            </div>
                                                        </div>
                                                    )
                            ...
                            <TabsContent value='skills'>
                                <div className="text-center xl:text-left">
                                    <h3 className="h3 mb-8">Aké technológie používam každý deň</h3>
                                    <div className="mb-16">
                                        <h4 className="text-xl font-semibold mb-2 xl:text-left">Zručnosti</h4>
                                        <div className="border-b border-border mb-4"></div>
                                        <div>
                                            {getData(skillData, 'zručnosti').data.map((item, index) => {
                                                const { name } = item;
                                                return(
                                    ...
                                    <div>
                                        <h4 className="text-xl font-semibold mb-2 xl:text-left">Nástroje</h4>
                                        <div className="border-b border-border mb-4"></div>
                                    </div>
                                    <div className="grid grid-cols-4 md:flex xl:gap-x-8 justify-center xl:justify-start">
                                        {getData(skillData, 'nástroje').data.map((item, index) => {
                                            const { imgPath } = item;
                                            return(
                                                <div key={index}>
                                                    <Magnetic>
